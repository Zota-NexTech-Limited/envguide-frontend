...
const DetailedPackagingEmission: React.FC = () => {
    ...
    useEffect(() => {
        if (!selectedClient) {
            setWasteData([
                { name: "Landfilling - MSW", displayName: "Landfilling", weight: 0.18, emission: 0.013 },
                { name: "Recycling", displayName: "Recycling", weight: 0.012, emission: -0.007 },
            ]);
        ...
        // Fetch waste/packaging treatment data
