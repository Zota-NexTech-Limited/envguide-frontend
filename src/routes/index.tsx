...
const EmissionFactorsTable = lazy(() => import("../pages/settings/EmissionFactorsTable"));
...
export const router = createBrowserRouter([
  ...
  knowledgeBaseRoute,
  {
    ...
    children: [
      ...
      // Unified BAFU 2025 Emission Factors master — replaces the legacy 6 ECOInvent setup pages.
      {
        path: "settings/emission-factors",
        element: (
          <PermissionRoute permissionKey="emission factors">
            <S>
