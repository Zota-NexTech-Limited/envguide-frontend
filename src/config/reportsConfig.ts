...
export const reportsConfig: ReportConfig[] = [
    ...
    },
    {
        ...
        columns: [
            ...
            { header: "Supplier ID/Code", key: "supplier_details.code", filterKey: "supplier_code" },
            { header: "Supplier Name", key: "supplier_details.supplier_name", filterKey: "supplier_name" },
            { header: "Manufacturing Region", key: "sites.location", filterKey: "manufacturing_region" },
            { header: "Component / Part Supplied", key: "component_name", filterKey: "component_name" },
            { header: "Material Type", key: "materials.material_name", filterKey: "material_type" },
            { header: "Energy Type Used in Manufacturing", key: "electricity.energy_type", filterKey: "energy_type" },
            { header: "Energy Quantity (kWh/kg)", key: "electricity.quantity", filterKey: "energy_quantity" },
            { header: "Recycled Content (%)", key: "recycled_content_percentage" },
            { header: "Emission Factor", key: "electricity.emission_factor" },
